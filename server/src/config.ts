...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8081';
    'jhipster.clientApp.name' = 'FSDevNodeInterview';
    ...
    'jhipster.mail.from' = 'FSDevNodeInterview@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'FSDevNodeInterview API';
    'jhipster.swagger.description' = 'FSDevNodeInterview API documentation';
    ...
    'eureka.instance.appname' = 'FSDevNodeInterview';
    'eureka.instance.instanceId' = 'FSDevNodeInterview:${random.value}';
    ...
    'cloud.config.name' = 'FSDevNodeInterview';
